...
class PhotoUtils {
  ...
  convertAndExtract({
    ...
    final safeName =
    sanitizeName(originalName.isNotEmpty ? originalName : 'foto');
    ...
    (fmt == pm.ImgFmt.jpeg) ? safeName : ensureJpgExtension(safeName);
    ...
    meta = meta.copyWith(
      ...
      takenAt:
      meta.takenAt ?? pm.parseDateFromFileName(finalName) ?? fallbackTakenAt,
    );
