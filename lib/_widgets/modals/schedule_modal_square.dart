// lib/_widgets/modals/schedule_modal_square.dart
...
class ScheduleModalSquare extends StatelessWidget {
  ...
  /// ⬇️ NOVO: callback disparado pelo botão "Apagar área"
              ...
              child: Column(
                ...
                children: [
                  ...
                  ScheduleActionsRow(
                    ...
                    // ⬇️ repassa o callback do modal para o botão "Apagar área"
                    onDelete: onDelete,
                    type: type,
                  ),
                ],
