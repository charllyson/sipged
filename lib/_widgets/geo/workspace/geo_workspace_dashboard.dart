...
class GeoWorkspaceDashboard extends StatefulWidget {
  const GeoWorkspaceDashboard({
    super.key,
    required this.item,
  ...
  @override
  State<GeoWorkspaceDashboard> createState() => _GeoWorkspaceDashboardState();
}

class _GeoWorkspaceDashboardState extends State<GeoWorkspaceDashboard> {
  bool _hovered = false;
  Rect? _dragRectStart;
  ...
  IconData _iconForResizeHandle(GeoWorkspaceResizeHandle handle) {
    switch (handle) {
      case GeoWorkspaceResizeHandle.left:
