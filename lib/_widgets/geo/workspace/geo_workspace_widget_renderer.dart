...
import 'package:sipged/_widgets/geo/workspace/geo_workspace_data_resolver.dart';
import 'package:sipged/_widgets/geo/workspace/geo_workspace_item_data.dart';

class GeoWorkspaceWidgetRenderer extends StatelessWidget {
  const GeoWorkspaceWidgetRenderer({
    super.key,
    required this.item,
    required this.size,
  ...
  Widget build(BuildContext context) {
    switch (item.type) {
      case GeoWorkspaceWidgetType.barVertical:
        final resolved = GeoWorkspaceDataResolver.resolveBarVertical(
          item: item,
      ...
      case GeoWorkspaceWidgetType.donut:
        final resolved = GeoWorkspaceDataResolver.resolveDonut(
          item: item,
          featuresByLayer: featuresByLayer,
        );
      ...
      case GeoWorkspaceWidgetType.line:
        final resolved = GeoWorkspaceDataResolver.resolveLine(
          item: item,
          featuresByLayer: featuresByLayer,
        );
      ...
      case GeoWorkspaceWidgetType.card:
        final resolved = GeoWorkspaceDataResolver.resolveCard(
          item: item,
          featuresByLayer: featuresByLayer,
        );
      ...
      case GeoWorkspaceWidgetType.kpi:
        final resolved = GeoWorkspaceDataResolver.resolveKpi(
          item: item,
          featuresByLayer: featuresByLayer,
        );
      ...
      case GeoWorkspaceWidgetType.table:
        final resolved = GeoWorkspaceDataResolver.resolveTable(
          item: item,
          featuresByLayer: featuresByLayer,
        );
