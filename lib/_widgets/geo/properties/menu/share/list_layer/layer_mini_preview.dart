...
import 'package:sipged/_widgets/geo/properties/menu/share/list_layer/layer_mini_preview_painter.dart';
import 'package:sipged/_widgets/geo/properties/menu/share/list_layer/layer_mini_preview_polygon.dart';

class MiniLayerPreview extends StatelessWidget {
  final LayerGeometryKind geometryKind;
  final GeoLayersDataSimple? symbol;
  final GeoLabelStyleData? label;
  ...
  const MiniLayerPreview.symbol({
    ...
    required GeoLayersDataSimple this.symbol,
    this.width = 24,
    this.height = 24,
  ...
  const MiniLayerPreview.label({
    super.key,
    required this.geometryKind,
    required GeoLabelStyleData this.label,
    this.width = 34,
    this.height = 24,
    this.showContainerBackground = false,
  }) : symbol = null;
  ...
  LayerSimpleMarkerShapeType get _shapeType =>
