...
import 'package:sipged/_widgets/geo/properties/menu/labels/labels_rule.dart';
import 'package:sipged/_widgets/geo/properties/menu/labels/labels_single.dart';
...
class LabelsMenu extends StatelessWidget {
  ...
  final ValueChanged<List<GeoLabelStyleData>> onLabelLayersChanged;
