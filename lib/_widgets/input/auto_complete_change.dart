...
class AutoCompleteChange<T extends Object> extends StatefulWidget {
  final String? label;
  ...
  @override
  State<AutoCompleteChange<T>> createState() => _AutoCompleteChangeState<T>();
}

class _AutoCompleteChangeState<T extends Object>
    extends State<AutoCompleteChange<T>> {
  String? _selectedId;
  ...
  @override
  void didUpdateWidget(covariant AutoCompleteChange<T> oldWidget) {
