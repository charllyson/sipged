// lib/_widgets/list/files/box_list_files.dart
...
class BoxListFiles extends StatefulWidget {
  final String title;
  ...
  @override
  State<BoxListFiles> createState() => _BoxListFilesState();
}

class _BoxListFilesState extends State<BoxListFiles> {
  ...
  @override
  void didUpdateWidget(covariant BoxListFiles oldWidget) {
