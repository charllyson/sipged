...
class DockPanelWorkspaceLogic {
  DockPanelWorkspaceLogic._();
  ...
  static List<DockPanelGroupData> mergeIncomingGroups({
    required List<DockPanelGroupData> incoming,
    required List<DockPanelGroupData> current,
    required bool preserveLayout,
  }) {
    final currentById = <String, DockPanelGroupData>{
  ...
  static List<DockPanelGroupData> normalizeDockSpans(
  ...
  static DockCrossSpan resolveTargetCrossSpan({
    ...
    required Offset localPosition,
    required List<DockPanelGroupData> baseGroups,
    required Size workspaceSize,
  }) {
  ...
  static List<DockPanelGroupData> projectDocking({
    required List<DockPanelGroupData> workingGroups,
  ...
  static Rect? resolveDockRectForArea({
    ...
    required List<DockPanelGroupData> source,
    required Size workspaceSize,
  }) {
  ...
  /// Área útil do conteúdo principal.
  ///
  /// Aqui a regra foi endurecida propositalmente:
  /// se existir dock visível em qualquer lado, o conteúdo central
  /// respeita esse lado integralmente.
  ///
  /// Isso garante que o mapa nunca fique por trás de nenhum painel dockado.
