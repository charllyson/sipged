...
class ClusterLayer<T> extends StatelessWidget {
  const ClusterLayer({
    super.key,
  ...
  final Widget Function(BuildContext, MarkerData<T>, bool isSelected)
  markerBuilder;
  ...
  Widget build(BuildContext context) {
    final sorted = List<MarkerData<T>>.from(taggedMarkers);
