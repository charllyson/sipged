...
import '../additive/additive_store.dart';
...
class ValidityStore extends ChangeNotifier {
  ...
  // ---------- Storage + Metadado ----------
  /// Upload via picker (Storage) e salva a URL no Firestore.
  ...
  /// Exclui o arquivo no Storage e limpa `pdfUrl` no Firestore.
  ...
  /// Verifica existência do PDF no Storage.
  ...
  /// Recupera a URL https do PDF no Storage.
