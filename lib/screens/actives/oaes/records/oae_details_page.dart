...
class _OaeDetailsPageState extends State<OaeDetailsPage> {
  ...
  void _handleNew() {
    ...
    setState(() {
      ...
      _widthCtrl.clear();
      _areaCtrl.clear();
      _structureTypeCtrl.clear();
      _relatedContractsCtrl.clear();
      _valueInterventionCtrl.clear();
      _linearCostMediaCtrl.clear();
      _costEstimateCtrl.clear();
      _companyBuildCtrl.clear();
      _latitudeCtrl.clear();
      _longitudeCtrl.clear();
      _altitudeCtrl.clear();
      _lastDateInterventionCtrl.clear();

      _lastDateIntervention = null;
      _createdAtStr = '-';
      _updatedAtStr = '-';
      _createdById = null;
      _updatedById = null;
      _createdByCtrl.clear();
      _updatedByCtrl.clear();
    });
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ActiveOaesCubit, ActiveOaesState>(
      builder: (context, st) {
        ...
        final List<UserData> allUsers = userState.all ?? const [];
