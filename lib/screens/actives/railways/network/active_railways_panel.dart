    ...
    return Stack(
      children: [
        ...
        Column(
          children: [
            Expanded(
              child: BlocBuilder<ActiveRailwaysBloc, ActiveRailwaysState>(
                builder: (context, st) {
                            ...
                            return SingleChildScrollView(
                              ...
                              child: SizedBox(
                                ...
                                child: BarChartChanged(
                                  ...
                                  values: st.regionSumsKm(), // km (internamente já filtra pelo pie)
                                  selectedIndex: selectedRegionIdx,
                                  onBarTap: (label) {
                                    final newRegion =
                                    label == st.selectedRegionFilter ? null : label;
                                    bloc.add(ActiveRailwaysRegionFilterChanged(newRegion));
                                  },
