...
class RoadDetailsView extends StatefulWidget {
  final RoadData road;
  final bool enabled;

  const RoadDetailsView({super.key, required this.road, this.enabled = true });

  @override
  State<RoadDetailsView> createState() => _RoadDetailsViewState();
}

class _RoadDetailsViewState extends State<RoadDetailsView> {
