...
import 'package:sipged/_widgets/draw/text/text_change_data_style.dart';
...
class SymbologyForm extends StatefulWidget {
  ...
  final ValueChanged<LayerDataSimple> onChanged;
...
class _SymbologyFormState extends State<SymbologyForm> {
  ...
  void _emit(LayerDataSimple value) {
