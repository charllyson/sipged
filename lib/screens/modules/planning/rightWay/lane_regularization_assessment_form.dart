...
class LaneRegularizationAssessmentForm extends StatefulWidget {
  ...
  @override
  State<LaneRegularizationAssessmentForm> createState() =>
      _LaneRegularizationAssessmentFormState();
}

class _LaneRegularizationAssessmentFormState
    extends State<LaneRegularizationAssessmentForm> {
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
              ...
              children: [
                Wrap(
                  ...
                  children: [
                    CustomTextField(
                      width: w,
                      controller: controller.appraisalNumberCtrl,
                      enabled: controller.isEditable,
                      labelText: 'Nº do Laudo',
                    ),
                    CustomTextField(
                      width: w,
                      controller: controller.appraiserNameCtrl,
                      enabled: controller.isEditable,
                      labelText: 'Avaliador/Empresa',
                    ),
                    CustomTextField(
                      width: w,
                      controller: controller.appraisalMethodCtrl,
                      enabled: controller.isEditable,
                      labelText: 'Método (NBR 14653 etc.)',
                    ),
                    CustomDateField(
                      width: w,
                      enabled: controller.isEditable,
                    ...
                    CustomTextField(
                      width: w,
                      controller: controller.appraisalValueCtrl,
                      enabled: controller.isEditable,
                      labelText: 'Valor Avaliado (R\$)',
                    ...
                    CustomTextField(
                      width: w,
                      controller: controller.ownerCounterCtrl,
                      enabled: controller.isEditable,
                      labelText: 'Contraproposta Proprietário (R\$)',
                      keyboardType: TextInputType.number,
                      inputFormatters: [
                        CurrencyInputFormatter(
                          leadingSymbol: 'R\$ ',
                    ...
                    CustomTextField(
                      width: w,
                      controller: controller.govProposalCtrl,
                      enabled: controller.isEditable,
                      labelText: 'Proposta do Órgão (R\$)',
                      keyboardType: TextInputType.number,
                      inputFormatters: [
                        CurrencyInputFormatter(
                          leadingSymbol: 'R\$ ',
            ...
            final side = SideListBox(
              ...
              enableRename: controller.isEditable && controller.selected != null,
              ...
              // ✅ persistência real (Firestore via controller)
              onRenamePersist: ({
                required int index,
