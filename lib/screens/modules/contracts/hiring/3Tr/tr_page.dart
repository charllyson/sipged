...
class _TermoReferenciaPageState extends State<TermoReferenciaPage>
  ...
  Future<void> _loadContract(String contractId) async {
    ...
    try {
      ...
      debugPrint(
        '[TermoReferenciaPage] Erro ao carregar contrato | '
            'tenantId=$_tenantId | '
            'contractId=$cid | '
            'erro=$error',
      );
  ...
  Future<void> _loadDfdData(String contractId) async {
    ...
    try {
      ...
      debugPrint(
        '[TermoReferenciaPage] Falha ao carregar DFD | '
            'tenantId=$_tenantId | '
            'contractId=$cid | '
            'erro=$error',
      );
  ...
  Future<bool> _saveOnly({
    ...
    try {
      ...
      debugPrint(
        '[TermoReferenciaPage] Erro em _saveOnly | '
            'tenantId=$_tenantId | '
            'contractId=$_contractId | '
            'erro=$error',
      );
  ...
  Future<void> _saveApproveAndNext() async {
    ...
    try {
      ...
      debugPrint(
        '[TermoReferenciaPage] Erro em _saveApproveAndNext | '
            'tenantId=$_tenantId | '
            'contractId=$_contractId | '
            'erro=$error',
      );
  ...
  Future<void> _updateApproved() async {
    ...
    try {
      ...
      debugPrint(
        '[TermoReferenciaPage] Erro em _updateApproved | '
            'tenantId=$_tenantId | '
            'contractId=$_contractId | '
            'erro=$error',
      );
                  ...
                  children: <Widget>[
                    ...
                    SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          RepaintBoundary(
                            child: SectionObjetoFundamentacao(
                              data: _formData,
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionLocalPrazosCronograma(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionMedicaoAceiteIndicadores(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionObrigacoesEquipeGestao(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionLicenciamentoSegurancaSustentabilidade(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionPrecosPagamentoReajuste(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionRiscosPenalidadesCondicoes(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
                          ...
                          const SizedBox(height: 12),
                          RepaintBoundary(
                            child: SectionDocumentosReferencias(
                              data: _formData,
                              isEditable: _isEditable,
                              onChanged: (updated) {
                                setState(() => _formData = updated);
