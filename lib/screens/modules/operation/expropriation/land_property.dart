...
import 'package:sipged/_blocs/modules/operation/schedule/expropriation/expropriation_data.dart';
import 'package:sipged/_blocs/modules/operation/schedule/expropriation/expropriation_state.dart';
...
class LandProperty extends StatefulWidget {
  ...
  @override
  State<LandProperty> createState() => _ExpropriationState();
}

class _ExpropriationState extends State<LandProperty> {
  ...
  void _initialize() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<ExpropriationCubit>().initialize(
  ...
  void _syncFromState(ExpropriationData d) {
  ...
  ExpropriationData _buildDraft(ExpropriationState state) {
  ...
  void _clearForm(ExpropriationState state) {
    final empty = ExpropriationData.empty(
    ...
    context.read<ExpropriationCubit>().updateDraft(empty);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ExpropriationCubit, ExpropriationState>(
      ...
      listener: (context, state) {
        ...
        if (error != null && error.isNotEmpty) {
          ...
          context.read<ExpropriationCubit>().clearMessages();
        }
      ...
      builder: (context, state) {
        final bloc = context.read<ExpropriationCubit>();
