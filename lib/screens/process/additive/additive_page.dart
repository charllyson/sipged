...
import '../../../../_blocs/process/additives/additive_controller.dart';
                                ...
                                children: [
                                  ...
                                  FutureBuilder<List<AdditiveData>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      final values = additives.map((e) => e.additiveValue ?? 0.0).toList(growable: false);
                                      final labels = additives.map((e) => (e.additiveOrder ?? '').toString()).toList(growable: false);
