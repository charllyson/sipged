...
class SectionReserva extends StatelessWidget {
  ...
  const SectionReserva({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        SectionTitle('4) Reserva Orçamentária / Planejamento'),
        Wrap(spacing: 12, runSpacing: 12, children: [
          SizedBox(width: _w(context), child: CustomTextField(controller: c.reservaNumeroCtrl, labelText: 'Nº da Reserva', enabled: c.isEditable)),
          SizedBox(
            width: _w(context),
