...
class LaneRegularizationPropertyForm extends StatefulWidget {
  ...
  @override
  State<LaneRegularizationPropertyForm> createState() => _LaneRegularizationPropertyFormState();
}

class _LaneRegularizationPropertyFormState extends State<LaneRegularizationPropertyForm> {
          ...
          final corpo = Column(
            ...
            children: [
              Wrap(spacing: 12, runSpacing: 12, children: [
                ...
                _input(context, controller.ufCtrl, 'UF', width: w,
                    inputFormatters: [UpperCaseTextFormatter(), LengthLimitingTextInputFormatter(2)]),

                _input(context, controller.roadNameCtrl, 'Rodovia/Trecho', width: w),
                DropDownButtonChange(
                  width: w,
                  enabled: controller.isEditable,
                ...
                _input(context, controller.kmStartCtrl, 'KM Inicial', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.,]'))]),
                _input(context, controller.kmEndCtrl, 'KM Final', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.,]'))]),
                _input(context, controller.corridorWidthCtrl, 'Largura de Corredor (m)', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.,]'))]),

                _input(context, controller.totalAreaCtrl, 'Área Total (m²)', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.,]'))]),
                _input(context, controller.affectedAreaCtrl, 'Área Atingida (m²)', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.,]'))]),
                ...
                _input(context, controller.centroidLatCtrl, 'Centroid Lat', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.\-]'))]),
                _input(context, controller.centroidLngCtrl, 'Centroid Lng', width: w,
                    keyboardType: TextInputType.number,
                    inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[\d\.\-]'))]),
              ]),
          ...
          final leftColumn = Column(
            children: [
              SideListBox(
                ...
                onEditLabel: (i) => controller.editGeoLabel(context, i),
                width: sideWidth,
              ),
              const SizedBox(height: 12),
              SideListBox(
