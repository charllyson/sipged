// lib/_widgets/schedule/schedule_square_modal.dart
...
// Widgets separados
import 'package:siged/screens/sectors/operation/schedule/photo_picker_square.dart';
import 'package:siged/screens/sectors/operation/schedule/save_summary.dart';
import 'package:siged/screens/sectors/operation/schedule/status_chips.dart';

class ScheduleSquareModal extends StatefulWidget {
  final int estaca;
  ...
  @override
  State<ScheduleSquareModal> createState() => _ScheduleSquareModalState();
}

class _ScheduleSquareModalState extends State<ScheduleSquareModal> {
  ...
  void initState() {
    ...
    if (kDebugMode) {
      debugPrint('[MODAL] init — estaca=${widget.estaca} faixa=${widget.faixaIndex} tipo=${widget.tipoLabel}');
  ...
  Future<void> _onSave(BuildContext context) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        Navigator.pop(context, SaveSummary(_newPhotos.length));
      }
    } finally {
      if (mounted) setState(() => _busy = false);
    }
