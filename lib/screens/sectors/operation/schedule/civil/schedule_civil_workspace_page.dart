// lib/screens/sectors/operation/civil/schedule_civil_workspace_page.dart
...
class _ScheduleCivilWorkspacePageState extends State<ScheduleCivilWorkspacePage> {
  ...
  static const double kCardMaxWidth = 520.0;
                  ...
                  Positioned.fill(
                    child: AnimatedBuilder(
                      ...
                      builder: (context, _) {
                        ...
                        final isWide = MediaQuery.sizeOf(context).width >= kBreakpoint;
                        final rightOffset = isWide && _panelOpen ? (kRightPanelWidth + 16) : 16.0;
