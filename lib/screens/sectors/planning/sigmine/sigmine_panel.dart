...
class SigminePanel extends StatelessWidget {
  const SigminePanel({
    super.key,
  ...
  final List<String> minerios;           // ⚠️ CHAVES NORMALIZADAS
  final List<int> contagens;
  final int? selectedIndex;              // índice do pie/seleção
  final Color Function(String) getColorForMinerio; // recebe chave normalizada
  ...
  Widget build(BuildContext context) {
    ...
    final String gaugeLabel = oneSelected ? minerios[selectedIndex!] : 'Total de jazidas';
    final int gaugeCount  = oneSelected ? contagens[selectedIndex!] : total;
    final double gaugePercent = total > 0 ? (gaugeCount / total).clamp(0.0, 1.0) : 0.0;
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const DividerText(title: 'Jazida de minério'),
              // =============== ROW HORIZONTAL: GAUGE + PIE ===============
              SingleChildScrollView(
                        ...
                        builder: (context, constraints) {
                          ...
                          return Padding(
                            ...
                            child: PieChartChanged(
                              ...
                              labels: minerios,
                              values: contagens.map((e) => e.toDouble()).toList(),
                              ...
                              sectionsSpace: 2,
                              onTouch: (idx) {
                                if (idx == null || idx >= minerios.length) return;
              ...
              ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  final ativo = (selectedIndex != null && i == selectedIndex) || selectedIndex == null;
                  ...
                  return ListTile(
                    ...
                    leading: Icon(
                      ...
                      color: (selectedIndex != null && i == selectedIndex) ? cor : Colors.grey,
                    ),
                    title: Text(
                      nome,
