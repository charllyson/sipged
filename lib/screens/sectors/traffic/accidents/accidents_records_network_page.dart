...
class _AccidentsRecordsNetworkPageState
  ...
  /// Evita que o primeiro callback automático do SelectorDates
  /// dispare um changeFilter que "apaga" os dados recém-carregados.
  bool _datesSelectorInitialized = false;
