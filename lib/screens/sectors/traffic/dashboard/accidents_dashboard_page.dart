...
import 'accidents_dashboard_controller.dart';
...
class AccidentsDashboardPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AccidentsDashboardController(),
      child: const _AccidentsDashboardScaffold(),
    );
  }
}
...
class _AccidentsDashboardScaffoldState extends State<_AccidentsDashboardScaffold> {
  ...
  void initState() {
    super.initState();
    // Inicializa após o primeiro frame — fora da fase de update do mouse/hover
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted) return;
      context.read<AccidentsDashboardController>().initialize();
    });
  }

  @override
  Widget build(BuildContext context) {
    return Consumer<AccidentsDashboardController>(
      builder: (context, c, _) {
        return Scaffold(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          AccidentsChartsSection(
                            ...
                            // highlight por padrão; use applyFilter: true nos handlers quando quiser filtrar
                          ...
                          AccidentsSelectorSection(
                            ...
                            onFilterChanged: (_, y, m) =>
                                c.onSelectorChanged(year: y, month: m),
                          ),
                          const SizedBox(height: 8),
                          const DividerText(
                          ...
                          // Mapa “burro”: sem Firestore ou lógica interna
                          AccidentsMapSection(
