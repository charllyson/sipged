...
class AccidentsMapPanel extends StatelessWidget {
  const AccidentsMapPanel({super.key,
    required this.state,
  ...
  Future<List<AccidentsData>> _fetchCityAccidentsFromState(String cityName) async {
    ...
    return state.view.where((a) => _normalizeCity(a.city) == key).toList();
  }
