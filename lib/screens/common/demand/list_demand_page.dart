  ...
  void _applyLocalSortIfAny() {
    ...
    int compare(ProcessData a, ProcessData b) {
      ...
      switch (_sortColumnIndex) {
        ...
        case 5:
          final aVal = (_dfdByContractId[idA]?.processoAdministrativo ?? '')
              .toUpperCase();
          final bVal = (_dfdByContractId[idB]?.processoAdministrativo ?? '')
              .toUpperCase();
          return aVal.compareTo(bVal);
    ...
    return BlocBuilder<ProcessCubit, ProcessState>(
      builder: (context, processState) {
        ...
        return Scaffold(
          ...
          floatingActionButton: ContractPermissions.isSuperUser(currentUser)
