...
class ChartsContractSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final datasets = controller.radarDatasetsServices(
      primary: ContractStyle.kPrimary,
      warning: ContractStyle.kWarning,
      success: ContractStyle.kSuccess,
    );
            ...
            children: [
              ...
              SizedBox(
                ...
                child: PieChartChanged(
                  ...
                  coresPersonalizadas: controller.labelsStatusOrdenados
                      .map(ContractStyle.getColorByStatus)
                      .toList(),
