...
import 'package:sisged/screens/documents/contract/dashboard/dashboard_contracts_chart_second_section.dart';

import 'package:sisged/screens/documents/measurement/dashboard/resumed_measurement_card.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (controller.houveInteracaoComFiltros &&
                    ...
                    ContractList(contract: controller.filteredContracts),
