...
import 'reports_measurement_controller.dart';
import 'reports_measurement_form_section.dart';
import 'reports_measurement_graph_section.dart';
import 'reports_measurement_table_section.dart';

class ReportsMeasurement extends StatelessWidget {
  const ReportsMeasurement({super.key, required this.contractData});
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ReportsMeasurementController(contract: contractData),
      builder: (context, _) {
        final c = context.read<ReportsMeasurementController>();
        ...
        return Stack(
          children: [
            Column(
              children: [
                Expanded(
                  child: Consumer<ReportsMeasurementController>(
                      ...
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            ReportsMeasurementGraphSection(
                              labels: labels,
                              values: values,
                            ...
                            Padding(
                              ...
                              child: ReportsMeasurementFormSection(
                                isEditable: ctrl.isEditable,
                                formValidated: ctrl.formValidated,
                                selectedAdjustmentMeasurement: ctrl.selectedReport,
                                currentAdjustmentMeasurementId: ctrl.currentReportId,
                            ...
                            // 🔽 TABELA COM PAGINAÇÃO DO CONTROLLER
                            ReportMeasurementTableSection(
                              ...
                              measurementsData: ctrl.reports, // página atual
            ...
            Consumer<ReportsMeasurementController>(
