// lib/_blocs/modules/planning/laneRegularization/lane_regularization_data.dart
...
class LaneRegularizationData extends ChangeNotifier {
  ...
  factory LaneRegularizationData.fromDocument(DocumentSnapshot snap) {
    ...
    DateTime? ts_(dynamic v) => (v is Timestamp) ? v.toDate() : null;
    double? num_(dynamic v) => (v is num)
        ? v.toDouble()
    ...
    return LaneRegularizationData(
      ...
      kmStart: num_(d['kmStart']),
      kmEnd: num_(d['kmEnd']),
      laneSide: d['laneSide'],
      corridorWidthM: num_(d['corridorWidthM']),
      centroidLat: num_(d['centroidLat']),
      centroidLng: num_(d['centroidLng']),
      geoAreaComputed: num_(d['geoAreaComputed']),
      processNumber: d['processNumber'],
      dupNumber: d['dupNumber'],
      dupDate: ts_(d['dupDate']),
      doPublication: d['doPublication'],
      doPublicationDate: ts_(d['doPublicationDate']),
      notificationAR: d['notificationAR'],
      notificationDate: ts_(d['notificationDate']),
      inspectionDate: ts_(d['inspectionDate']),
      appraisalDate: ts_(d['appraisalDate']),
      agreementDate: ts_(d['agreementDate']),
      paymentDate: ts_(d['paymentDate']),
      possessionDate: ts_(d['possessionDate']),
      evictionDate: ts_(d['evictionDate']),
      registryUpdateDate: ts_(d['registryUpdateDate']),
      appraisalNumber: d['appraisalNumber'],
      appraiserName: d['appraiserName'],
      appraisalMethod: d['appraisalMethod'],
      appraisalValue: num_(d['appraisalValue']),
      totalArea: num_(d['totalArea']),
      affectedArea: num_(d['affectedArea']),
      indemnityValue: num_(d['indemnityValue']),
      ownerCounterValue: num_(d['ownerCounterValue']),
      govProposalValue: num_(d['govProposalValue']),
      ...
      depositInCourtValue: num_(d['depositInCourtValue']),
      ...
      email: d['email'],
      notes: d['notes'],
      createdAt: ts_(d['createdAt']),
      createdBy: d['createdBy'],
      updatedAt: ts_(d['updatedAt']),
