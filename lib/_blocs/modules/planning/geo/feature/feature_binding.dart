...
class FeatureDataBinding {
  ...
  factory FeatureDataBinding.fromMap(Map<String, dynamic>? map) {
    if (map == null) return const FeatureDataBinding();
  ...
  bool operator ==(Object other) {
    return other is FeatureDataBinding &&
