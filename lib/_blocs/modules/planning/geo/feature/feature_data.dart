...
class FeatureData extends Equatable {
  ...
  factory FeatureData.fromFirestore({
  ...
  factory FeatureData.fromImportedRawFeature(
  ...
  FeatureGeometryFamily get geometryFamily {
    switch (geometryType) {
  ...
  static FeatureGeometryType mapGeoJsonType(String raw) {
    switch (raw.toLowerCase()) {
      case 'point':
        return FeatureGeometryType.point;
      case 'multipoint':
        return FeatureGeometryType.multiPoint;
      case 'linestring':
        return FeatureGeometryType.lineString;
      case 'multilinestring':
        return FeatureGeometryType.multiLineString;
      case 'polygon':
        return FeatureGeometryType.polygon;
      case 'multipolygon':
        return FeatureGeometryType.multiPolygon;
      default:
        return FeatureGeometryType.unknown;
    }
  }
  ...
  static FeatureParsedGeometry parseGeometry({
    required FeatureGeometryType geometryType,
    ...
    switch (geometryType) {
      ...
      case FeatureGeometryType.multiPoint:
        ...
        return FeatureParsedGeometry(markerPoints: pts);
      ...
      case FeatureGeometryType.multiLineString:
        ...
        return FeatureParsedGeometry(lineParts: lines);
      ...
      case FeatureGeometryType.polygon:
        ...
        return FeatureParsedGeometry(polygonRings: rings);
      ...
      case FeatureGeometryType.unknown:
        return const FeatureParsedGeometry();
    }
  }
