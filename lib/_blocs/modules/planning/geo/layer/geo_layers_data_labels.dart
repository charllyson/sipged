...
class GeoLabelStyleData {
  ...
  factory GeoLabelStyleData.fromMap(Map<String, dynamic> map) {
    return GeoLabelStyleData(
      id: (map['id'] ?? '').toString(),
  ...
  bool operator ==(Object other) {
    return other is GeoLabelStyleData &&
        other.id == id &&
        other.title == title &&
        other.text == text &&
...
class GeoLabelRuleData {
  ...
  factory GeoLabelRuleData.fromMap(Map<String, dynamic> map) {
    return GeoLabelRuleData(
      ...
      style: GeoLabelStyleData.fromMap(
