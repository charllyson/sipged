...
class GeoToolboxCubit extends Cubit<GeoToolboxState> {
  GeoToolboxCubit() : super(const GeoToolboxState());
  ...
  GeoToolboxState _buildState(List<LatLng> points) {
