// lib/_blocs/modules/contracts/hiring/10Arquivamento/termo_arquivamento_storage_bloc.dart
...
/// contracts/{contractId}/arquivamento/{taId}/pecas/{pecasDocId}/files/{file}
class TermoArquivamentoStorageBloc {
  TermoArquivamentoStorageBloc({FirebaseStorage? firebaseStorage})
  ...
  String _filesPath({
    ...
    return 'contracts/$contractId/arquivamento/$taId/pecas/$pecasDocId/files';
  }
  ...
  Future<List<Attachment>> list({
    ...
    if (cleanContractId.isEmpty || cleanTaId.isEmpty || cleanPecasDocId.isEmpty) {
