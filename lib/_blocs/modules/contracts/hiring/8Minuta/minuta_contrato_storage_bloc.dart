// lib/_blocs/modules/contracts/hiring/8Minuta/minuta_contrato_storage_bloc.dart
...
class MinutaContratoStorageBloc {
  MinutaContratoStorageBloc({FirebaseStorage? firebaseStorage})
  ...
  String _filesPath({
    ...
    return 'contracts/$contractId/minuta/$minutaId/gestao_refs/$gestaoId/files';
  }
