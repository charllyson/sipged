...
class AdjustmentMeasurementData {
  ...
  static CollectionReference<Map<String, dynamic>> tenantCol(
  ...
  static DocumentReference<Map<String, dynamic>> tenantDocRef(
      FirebaseFirestore db, {
        required String tenantId,
        required String contractId,
        required String id,
  ...
  factory AdjustmentMeasurementData.fromMap(
      Map<String, dynamic> json, {
        String? id,
        String? fallbackContractId,
      }) {
    return AdjustmentMeasurementData(
      id: id ?? _toStringOrNull(_pick(json, const ['id'])),
      order: _toInt(
        _pick(
          json,
          const [
