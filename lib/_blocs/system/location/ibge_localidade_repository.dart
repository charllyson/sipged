...
class IBGELocationRepository {
  ...
  IBGELocationRepository({
    IBGELocationService? service,
  }) : _service = service ?? IBGELocationService();

  // Cache em memória: evita bater na API toda hora.
  static final Map<int, List<Polygon<Map<String, dynamic>>>>
  _cachePolygonsByUf = {};
  ...
  Future<List<Polygon<Map<String, dynamic>>>> getMunicipioPolygonsByUf(
      int ufCode,
      ) async {
    final cached = _cachePolygonsByUf[ufCode];
