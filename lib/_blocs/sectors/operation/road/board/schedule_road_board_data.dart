// lib/_blocs/sectors/operation/road/board/schedule_road_board_data.dart
...
class ScheduleRoadBoardData {
  ...
  factory ScheduleRoadBoardData.fromMap(Map<String, dynamic> m, {ScheduleRoadBoardData? meta}) {
    final def = ScheduleRoadBoardData(
      numero: 0,
      faixaIndex: 0,
      key: 'geral',
      label: 'GERAL',
  ...
  ScheduleRoadBoardData copyWith({
    int? numero,
    int? faixaIndex,
    String? tipo,
    String? status,
