...
class LaneRegularizationController extends ChangeNotifier
  ...
  List<LaneRegularizationData> _snapshot = [];
  ...
  Future<String?> _askLabelDialog(BuildContext ctx, String suggestion) async {
  ...
  Future<void> addGeoFile(BuildContext context) async {
    ...
    try {
      ...
      final label = (await _askLabelDialog(context, suggestion))?.trim();
