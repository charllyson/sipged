...
class ApostillesState extends Equatable {
  final ApostillesStatus status;
  final List<ApostillesData> apostilles;
  final ApostillesData? selected;
  ...
  factory ApostillesState.initial() {
    return const ApostillesState(
      status: ApostillesStatus.initial,
      apostilles: <ApostillesData>[],
      selected: null,
      isSaving: false,
      isEditable: true,
      editingMode: false,
  ...
  ApostillesState copyWith({
    ApostillesStatus? status,
    List<ApostillesData>? apostilles,
    ApostillesData? selected,
    bool? isSaving,
    bool? isEditable,
    bool? editingMode,
    bool? formValid,
