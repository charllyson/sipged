// ==============================
// lib/_datas/process/contracts/apostilles/apostilles_store.dart
// ==============================
import 'dart:async';
...
class ApostillesStore extends ChangeNotifier {
  ...
  /// 🆕 salva (ou atualiza) no Firestore a lista de attachments completos
  Future<void> setAttachments({
    required String contractId,
    required String apostilleId,
    required List<Attachment> attachments,
  }) async {
    await _bloc.setAttachments(
