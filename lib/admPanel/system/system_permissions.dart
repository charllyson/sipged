...
class SystemPermissions extends StatefulWidget {
  const SystemPermissions({super.key});

  @override
  State<SystemPermissions> createState() =>
      _SystemPermissionsState();
}

class _SystemPermissionsState
    extends State<SystemPermissions> {
  bool _didInit = false;
