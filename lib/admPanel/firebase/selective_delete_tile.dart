...
class SelectiveDeleteSubcollectionTile extends StatelessWidget {
  ...
  Future<void> _closeLoading(NavigatorState nav) async {
    if (nav.canPop()) {
      nav.pop();
    }
  }
  ...
  Widget build(BuildContext context) {
    return TileWidget(
      ...
      onTap: () async {
        ...
        switch (mode) {
          case _Mode.byIds:
            await _handleDeleteByIds(context, nav);
            break;

          case _Mode.byFilter:
            await _handleDeleteByFilter(context, nav);
            break;
        }
      },
    );
  ...
  Future<void> _handleDeleteByIds(
      BuildContext context,
      NavigatorState nav,
      ) async {
  ...
  Future<void> _handleDeleteByFilter(
      BuildContext context,
      NavigatorState nav,
      ) async {
  ...
  Future<_ByIdsParams?> _askByIds(BuildContext context) async {
    ...
    try {
      return await showWindowDialog<_ByIdsParams>(
        context: context,
  ...
  Future<_ByFilterParams?> _askByFilter(BuildContext context) async {
    ...
    try {
      return await showWindowDialog<_ByFilterParams>(
        context: context,
