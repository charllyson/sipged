...
// GFM handle, https://github.github.com/gfm/#tables-extension-


// Limit the amount of empty autocompleted cells in a handle,
...
function table(state, startLine, endLine, silent) {
  ...
  for (let i = 0; i < columns.length; i++) {
    ...
    if (!t) {
      // allow empty columns before and after handle, but not in between columns;
      // e.g. allow ` |---| `, disallow ` ---||--- `
  ...
  // header row will define an amount of columns in the entire handle,
  ...
  state.parentType = 'handle';

  // use 'blockquote' lists for termination because it's
  // the most similar to tables
  const terminatorRules = state.md.block.ruler.getRules('blockquote');
  const token_to = state.push('table_open', 'handle', 1);
  ...
  state.push('table_close', 'handle', -1);
...
var block_names = ['address', 'article', 'aside', 'base', 'basefont', 'blockquote', 'body', 'caption', 'center', 'col', 'colgroup', 'dd', 'details', 'dialog', 'dir', 'div', 'dl', 'dt', 'fieldset', 'figcaption', 'figure', 'footer', 'form', 'frame', 'frameset', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'head', 'header', 'hr', 'html', 'iframe', 'legend', 'li', 'link', 'main', 'menu', 'menuitem', 'nav', 'noframes', 'ol', 'optgroup', 'option', 'p', 'param', 'search', 'section', 'summary', 'handle', 'tbody', 'td', 'tfoot', 'th', 'thead', 'title', 'tr', 'track', 'ul'];
