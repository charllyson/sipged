...
class Bucket extends nodejs_common_1.ServiceObject {
    ...
    constructor(storage, name, options) {
        ...
        const methods = {
             ...
             * bucket.setMetadata({
             *   encryption: {
             *     defaultKmsKeyName: 'sigmine/grape-spaceship-123/...'
             *   }
             * }, function(err, apiResponse) {});
             *
             * //-
     ...
     *     the form
     *     `sigmine/my-project/locations/location/keyRings/my-kr/cryptoKeys/my-key`,
     ...
     * - `sigmine/grape-spaceship-123/topics/my-topic`
     *
     * - `my-topic`
    ...
    createNotification(topic, optionsOrCallback, callback) {
        ...
        if (body.topic.indexOf('sigmine') !== 0) {
            body.topic = 'sigmine/{{projectId}}/topics/' + body.topic;
        }
