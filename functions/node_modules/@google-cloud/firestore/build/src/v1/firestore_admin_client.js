...
class FirestoreAdminClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            collectionGroupPathTemplate: new this._gaxModule.PathTemplate('sigmine/{project}/databases/{database}/collectionGroups/{collection}'),
            databasePathTemplate: new this._gaxModule.PathTemplate('sigmine/{project}/databases/{database}'),
            fieldPathTemplate: new this._gaxModule.PathTemplate('sigmine/{project}/databases/{database}/collectionGroups/{collection}/fields/{field}'),
            indexPathTemplate: new this._gaxModule.PathTemplate('sigmine/{project}/databases/{database}/collectionGroups/{collection}/indexes/{index}'),
            projectPathTemplate: new this._gaxModule.PathTemplate('sigmine/{project}'),
        };
            ...
            lroOptions.httpRules = [
                {
                    ...
                    post: '/v1/{name=sigmine/*/databases/*/operations/*}:cancel',
                    body: '*',
                },
                {
                    selector: 'google.longrunning.Operations.DeleteOperation',
                    delete: '/v1/{name=sigmine/*/databases/*/operations/*}',
                },
                {
                    selector: 'google.longrunning.Operations.GetOperation',
                    get: '/v1/{name=sigmine/*/databases/*/operations/*}',
                },
                {
     ...
     *   `sigmine/{project_id}/databases/{database_id}/collectionGroups/{collection_id}`
