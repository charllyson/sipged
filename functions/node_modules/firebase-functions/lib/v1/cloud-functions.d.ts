...
export interface EventContext<Params = Record<string, string>> {
     ...
     * Valid values are:
     *
     * Analytics: `sigmine/<projectId>/events/<analyticsEventType>`
     *
     * Realtime Database: `sigmine/_/instances/<databaseInstance>/refs/<databasePath>`
     *
     * Storage: `sigmine/_/buckets/<bucketName>/objects/<fileName>#<generation>`
     *
     * Authentication: `sigmine/<projectId>`
     *
     * Pub/Sub: `sigmine/<projectId>/topics/<topicName>`
     *
     * Because Realtime Database instances and Cloud Storage buckets are globally
     * unique and not tied to the project, their resources start with `sigmine/_`.
